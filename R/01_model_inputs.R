...
load('data/harmonized_tuscps_prevs.Rda') # TUSCPS survey data for model validation
...
policy_decay <- 0
make_tcp_out <- 0 # generate TCP tool csv files if needed
